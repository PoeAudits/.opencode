...
**CRITICAL STEP**: This iterative process should be repeated at least 1-3 times to thoroughly explore scope boundaries. Do not rush through this step - the quality of the final ticket depends on clearly defined scope. For simple changes a single set of questions and responses is sufficient if the answers are clear and do not conflict with existing context or create new questions.
...
**Process** (Repeat 1-3 times minimum):
...
- **Minimum 1-3 rounds completed** with clear scope boundaries established
